...
export const QrModal =
	(
		{modalVisible, closeModal, error, crypto_slug, description, per_user, isSuccess, isLoading}:
			{
			...
			>
				<View style={styles.overlay}>
					<AppCard style={{
						...
						backgroundColor: isLoading ? activeTheme.backgroundPrimary : isSuccess ? 'rgba(22, 163, 74, 1)' : activeTheme.error
					}}>
						{
							isLoading ?
								<ActivityIndicator/> :
								isSuccess ?
									<>
										...
										<View>
											<AppText style={{alignSelf: 'center', fontSize: 24}}
															 bold>+{per_user} {crypto_slug}</AppText>
